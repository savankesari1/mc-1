...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    const drawGrid = () => {
      ...
      // We remove the default center gradient mask so it doesn't mask out the edges for this project.
      // If the original look is desired, we can add a subtle radial gradient mask later.
    };
